          ...
          {selectedLog && (
            <div className="flex flex-col h-full">
              <SheetHeader className="bg-white p-6 border-b sticky top-0 z-10 shadow-sm">
                ...
                <SheetTitle className="break-all font-mono text-sm text-blue-700 border p-2 rounded bg-blue-50/50">
                  {selectedLog.ApiUrl}
                </SheetTitle>
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-slate-950 text-slate-50 rounded-lg border border-slate-800 shadow-inner overflow-hidden">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-slate-950 text-emerald-50 rounded-lg border border-slate-800 shadow-inner overflow-hidden">
